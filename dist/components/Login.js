...
const Login = ({ setToken }) => {
    ...
    return (react_1.default.createElement("form", { onSubmit: handleSubmit, className: "formLogin" },
        ...
        react_1.default.createElement("input", { className: isWrongCredentials ? "inputLogin wrongCredentials" : "inputLogin", type: "text", value: username, placeholder: "Username", onChange: (e) => setUsername(e.target.value) }),
